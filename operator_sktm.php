...
<head>
	...
	<script language="javascript">
			function pesan_sktm(form_sktm){

			if(form_sktm.no_surat_sktm.value == ""){
				alert("No surat belum di isi !");
				form_sktm.no_surat_sktm.focus();
				return (false);
	
			}else if(form_sktm.nama.value == "0"){
				alert("Yang bertanda tangan belum di pilih !");
				form_sktm.nama.focus();
				return (false);
	
			}else if(form_sktm.nama_p.value == "0"){
				alert("Nama belum di pilih !");
				form_sktm.nama_p.focus();
				return (false);
			}
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator-tabel-sktm.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>INPUTAN SURAT KETERANGAN TIDAK MAMPU</h3>
							</div>
							<div class="module-body">
									<form name="form_sktm" onsubmit="return pesan_sktm(this)" class="form-horizontal row-fluid" method="post" action="operator-proses-simpan-sktm.php">	
									 <?php
										include "koneksi.php";
										$query   = "SELECT max(id_sktm) as maxKode FROM tbl_sktm";
										...
										?>
                                      	...
                                      	<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_sktm" id="basicinput" class="span8" value="<?php echo $idsurat; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_sktm" id="basicinput" class="span8" placeholder="...." autocomplete="off">
											</div>
										</div>
