				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="skbdnama.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                           ...
                                           $query = mysqli_query($config, " SELECT * FROM tbl_bdnama, tbl_pegawai, tbl_penduduk WHERE tbl_bdnama.id_pg=tbl_pegawai.id_pg AND tbl_bdnama.NIK=tbl_penduduk.NIK ORDER BY tbl_bdnama.id_bd_nama ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='cetak-skbdnama.php?id_bd_nama=$data[id_bd_nama]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-skbdnama.php?id_bd_nama=$data[id_bd_nama]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-skbdnama.php?id_bd_nama=$data[id_bd_nama]'>
