				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="skd.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                           ...
                                           $query = mysqli_query($config, " SELECT * FROM tbl_skd, tbl_pegawai, tbl_penduduk WHERE tbl_skd.id_pg=tbl_pegawai.id_pg AND tbl_skd.NIK=tbl_penduduk.NIK ORDER BY tbl_skd.id_skd ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='cetak-skd.php?id_skd=$data[id_skd]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-skd.php?id_skd=$data[id_skd]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-skd.php?id_skd=$data[id_skd]'>
