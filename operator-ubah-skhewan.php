...
$query    		  = mysqli_query($config, " SELECT * FROM  tbl_s_ket_hewan where id_s_ket_hewan='$id_s_ket_hewan'");
$a=mysqli_fetch_array($query);
$id_s_ket_hewan  	= $a['id_s_ket_hewan'];
$no_surat_skhewan   = $a['no_surat_skhewan'];
$ket      			= $a['ket'];
$ciri_ciri 			= $a['ciri_ciri'];
?>
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="operator-tabel-skhewan.php"><i class="menu-icon icon-backward"></i>KEMBALI
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>UBAH SURAT KETERANGAN HEWAN</h3>
							</div>
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="operator-proses-ubah-skhewan.php">
										<?php
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_s_ket_hewan" id="basicinput" class="span8" value="<?php echo $id_s_ket_hewan; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_skhewan" id="basicinput" class="span8" placeholder="...." autocomplete="off" value="<?php echo $no_surat_skhewan; ?>">
											</div>
										</div>
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Ciri - Ciri Hewan Tersebut</label>
											<div class="controls">
												<textarea name="ciri_ciri" class="span8" rows="5"><?php echo $ciri_ciri; ?></textarea>
											</div>
										</div>
