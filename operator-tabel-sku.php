				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator_sku.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>TABEL SURAT KETERANGAN USAHA</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'koneksi.php';
                                           $query = mysqli_query($config, " SELECT * FROM tbl_sku, tbl_pegawai, tbl_penduduk WHERE tbl_sku.id_pg=tbl_pegawai.id_pg AND tbl_sku.NIK=tbl_penduduk.NIK ORDER BY tbl_sku.id_sku ASC");

                                                while($data=mysqli_fetch_assoc($query)){

                                                 echo '<tr>';
                                                 echo '<td>'.$data['id_sku'].'</td>';
                                                 echo '<td>'.$data['jabatan'].'</td>';
                                                 echo '<td>'.$data['no_surat_sku'].'</td>';
                                                 echo '<td>'.$data['nama_p'].'</td>';
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='operator-cetak-sku.php?id_sku=$data[id_sku]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-ubah-sku.php?id_sku=$data[id_sku]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-hapus-sku.php?id_sku=$data[id_sku]'>
