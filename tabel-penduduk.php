				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="penduduk.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'koneksi.php';
                                            $query = mysqli_query($config, "SELECT * FROM tbl_penduduk ORDER BY NIK ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                                                 ...
                                                 echo"<td>
                                                  		<center>
                        						 		<a href='profil-lengkap-penduduk.php?NIK=$data[NIK]'>
                        						 		...
                        						 		<center>
                        						 		<a href='cetak-profil-lengkap-penduduk.php?NIK=$data[NIK]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-penduduk.php?NIK=$data[NIK]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-penduduk.php?NIK=$data[NIK]'>
