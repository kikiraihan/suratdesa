					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>TABEL DATA SURAT KETERANGAN</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'../koneksi.php';
                                           $query = mysqli_query($config, " SELECT * FROM tbl_s_ket,  tbl_instansi, tbl_pegawai, tbl_penduduk WHERE tbl_s_ket.id_pg=tbl_pegawai.id_pg AND tbl_s_ket.id_instansi=tbl_instansi.id_instansi AND tbl_s_ket.NIK=tbl_penduduk.NIK ORDER BY tbl_s_ket.id_s_ket ASC");

                                                while($data=mysqli_fetch_assoc($query)){

                                                 echo '<tr>';
                                                 echo '<td>'.$data['id_s_ket'].'</td>';
