					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>TABEL DATA SURAT KETERANGAN HILANG</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'../koneksi.php';
                                            $query = mysqli_query($config, " SELECT * FROM tbl_skh, tbl_instansi, tbl_pegawai WHERE tbl_skh.id_instansi=tbl_instansi.id_instansi AND tbl_skh.id_pg=tbl_pegawai.id_pg ORDER BY tbl_skh.id_skh ASC");
