					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>TABEL DATA SURAT KETERANGAN USAHA</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'../koneksi.php';
                                           $query = mysqli_query($config, " SELECT * FROM tbl_sku,  tbl_instansi, tbl_pegawai, tbl_penduduk WHERE tbl_sku.id_pg=tbl_pegawai.id_pg AND tbl_sku.id_instansi=tbl_instansi.id_instansi AND tbl_sku.NIK=tbl_penduduk.NIK ORDER BY tbl_sku.id_sku ASC");
