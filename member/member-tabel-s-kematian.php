					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>TABEL DATA SURAT KEMATIAN</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'../koneksi.php';
                                           $query = mysqli_query($config, " SELECT * FROM tbl_s_kematian,  tbl_instansi, tbl_pegawai, tbl_penduduk WHERE tbl_s_kematian.id_pg=tbl_pegawai.id_pg AND tbl_s_kematian.id_instansi=tbl_instansi.id_instansi AND tbl_s_kematian.NIK=tbl_penduduk.NIK ORDER BY tbl_s_kematian.id_s_kematian ASC");
