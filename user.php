				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="tambah-user.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'koneksi.php';
                                            $query = mysqli_query($config, "SELECT * FROM tbl_user ORDER BY id_user ASC");
                                            ...
                                            while($data=mysqli_fetch_assoc($query)){
                                              ...
                                              if($data['id_user'] > 1){
                                        			...
                                        			echo"<td>
                        						 		<center>
                        						 		<a href='ubah-user.php?id_user=$data[id_user]'>
                        						 			<font face='arial' size='2' color='green'>
                        						 				UBAH
                        						 			</font>
                        						 		</a>

                        						 		<a href='hapus-user.php?id_user=$data[id_user]'>
                                        		...
                                        		if($data['id_user'] == 1){
                                            		...
                                            		echo '<td>'.$data['nama_user'].'</td>';
                                            		echo '<td>'.$data['hak_akses'].'</td>';
                                        			echo '<td><b><center>TIDAK ADA AKSI</center></b></td>';
                                        		}else{
