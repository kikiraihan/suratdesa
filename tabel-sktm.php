				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="sktm.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                           ...
                                           $query = mysqli_query($config, " SELECT * FROM tbl_sktm, tbl_pegawai, tbl_penduduk WHERE tbl_sktm.id_pg=tbl_pegawai.id_pg AND tbl_sktm.NIK=tbl_penduduk.NIK ORDER BY tbl_sktm.id_sktm ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='cetak-sktm.php?id_sktm=$data[id_sktm]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-sktm.php?id_sktm=$data[id_sktm]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-sktm.php?id_sktm=$data[id_sktm]'>
