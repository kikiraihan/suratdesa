				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator_skd.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>TABEL SURAT KETERANGAN DOMISILI</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'koneksi.php';
                                           $query = mysqli_query($config, " SELECT * FROM tbl_skd, tbl_pegawai, tbl_penduduk WHERE tbl_skd.id_pg=tbl_pegawai.id_pg AND tbl_skd.NIK=tbl_penduduk.NIK ORDER BY tbl_skd.id_skd ASC");

                                                while($data=mysqli_fetch_assoc($query)){

                                                 echo '<tr>';
                                                 echo '<td>'.$data['id_skd'].'</td>';
                                                 echo '<td>'.$data['jabatan'].'</td>';
                                                 echo '<td>'.$data['no_surat_skd'].'</td>';
                                                 echo '<td>'.$data['nama_p'].'</td>';
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='operator-cetak-skd.php?id_skd=$data[id_skd]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-ubah-skd.php?id_skd=$data[id_skd]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-hapus-skd.php?id_skd=$data[id_skd]'>
