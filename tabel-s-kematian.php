				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="s_kematian.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                           ...
                                           $query = mysqli_query($config, " SELECT * FROM tbl_s_kematian, tbl_pegawai, tbl_penduduk WHERE tbl_s_kematian.id_pg=tbl_pegawai.id_pg AND tbl_s_kematian.NIK=tbl_penduduk.NIK ORDER BY tbl_s_kematian.id_s_kematian ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='cetak-s-kematian.php?id_s_kematian=$data[id_s_kematian]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-s-kematian.php?id_s_kematian=$data[id_s_kematian]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-s-kematian.php?id_s_kematian=$data[id_s_kematian]'>
