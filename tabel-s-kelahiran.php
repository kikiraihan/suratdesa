				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="s_kelahiran.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                           ...
                                           $query = mysqli_query($config, " SELECT * FROM tbl_s_kelahiran, tbl_pegawai WHERE tbl_s_kelahiran.id_pg=tbl_pegawai.id_pg ORDER BY tbl_s_kelahiran.id_s_kelahiran ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='cetak-s-kelahiran.php?id_s_kelahiran=$data[id_s_kelahiran]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-s-kelahiran.php?id_s_kelahiran=$data[id_s_kelahiran]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-s-kelahiran.php?id_s_kelahiran=$data[id_s_kelahiran]'>
