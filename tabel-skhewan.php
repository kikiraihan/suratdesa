				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="skhewan.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                           ...
                                           $query = mysqli_query($config, " SELECT * FROM tbl_s_ket_hewan, tbl_pegawai, tbl_penduduk WHERE tbl_s_ket_hewan.id_pg=tbl_pegawai.id_pg AND tbl_s_ket_hewan.NIK=tbl_penduduk.NIK ORDER BY tbl_s_ket_hewan.id_s_ket_hewan ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='cetak-skhewan.php?id_s_ket_hewan=$data[id_s_ket_hewan]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-skhewan.php?id_s_ket_hewan=$data[id_s_ket_hewan]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-skhewan.php?id_s_ket_hewan=$data[id_s_ket_hewan]'>
