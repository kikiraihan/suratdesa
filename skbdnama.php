				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="tabel-skbdnama.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form name="form_skbdnama" onsubmit="return pesan_skbdnama(this)" class="form-horizontal row-fluid" method="post" action="proses-simpan-skbdnama.php">	
									 <?php
										include "koneksi.php";
