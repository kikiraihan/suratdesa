				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator_skkb.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                           ...
                                           $query = mysqli_query($config, " SELECT * FROM tbl_skkb, tbl_pegawai, tbl_penduduk WHERE tbl_skkb.id_pg=tbl_pegawai.id_pg AND tbl_skkb.NIK=tbl_penduduk.NIK ORDER BY tbl_skkb.id_skkb ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='operator-cetak-skkb.php?id_skkb=$data[id_skkb]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-ubah-skkb.php?id_skkb=$data[id_skkb]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-hapus-skkb.php?id_skkb=$data[id_skkb]'>
