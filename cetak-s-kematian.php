...
include "koneksi.php";
$id_s_kematian  =  mysqli_escape_string($config,$_GET['id_s_kematian']);
$query          =  mysqli_query($config, " SELECT * FROM tbl_s_kematian JOIN tbl_pegawai JOIN tbl_penduduk ON tbl_s_kematian.id_pg = tbl_pegawai.id_pg AND tbl_s_kematian.NIK=tbl_penduduk.NIK WHERE tbl_s_kematian.id_s_kematian='$id_s_kematian'");
while($data    =  mysqli_fetch_array($query)){                   
$id_s_kematian       = $data['id_s_kematian'];
$no_surat_skmati     = $data['no_surat_skmati'];
$nama                = $data['nama'];
...
$jenkel              = $data['jenkel'];
$alamat              = $data['alamat'];
$meninggal_tanggal   = $data['meninggal_tanggal'];
$umur_meninggal      = $data['umur_meninggal'];
$warga_negara        = $data['warga_negara'];
$tmpt_meninggal      = $data['tmpt_meninggal'];
$ket                 = $data['ket'];
...
$tahun = date ('Y');
$nomor = "NO:474.2/BGM-TKBL/".$no_surat_skmati."/".$romawi."/".$tahun;
...
echo "<table align='center' border='0' width='100%' height='100%'>
        <tr>
            <td align='center'>
                <u style='font-size:20px; font-weight:bold;' align='center'>SURAT KETERANGAN KEMATIAN</u>
            </td>
        </tr>
        <tr>
...
echo  "<br><table border='0' style='margin-left:60px;' width='100%' height='100%'>
    ...
    echo "<br><table border='0' style='margin-left:60px;' width='100%' height='100%'>
            ...
            <tr>
                <td>
                    <label style='font-family:times; font-size:16px;'>T.T.L</label>
                </td>
                <td>
                    <label style='font-family:times; font-size:16px;'>:</label></td>
                <td>
                    <label style='font-family:times; font-size:16px;'>".$tgl_lhr."</label>
                </td>
            </tr>
              ...
              <tr>
               ...
               <tr>
                 ...
                 <tr>
                  <td>
                      <label style='font-family:times; font-size:16px;'>Meninggal Tanggal</label>
                  </td>
                  <td>
                      <label style='font-family:times; font-size:16px;'>:</label></td>
                  <td>
                      <label style='font-family:times; font-size:16px;'>".$meninggal_tanggal."</label>
                  </td>
                </tr>

                 <tr>
                  <td>
                      <label style='font-family:times; font-size:16px;'>Umur Meninggal</label>
                  </td>
                  <td>
                      <label style='font-family:times; font-size:16px;'>:</label></td>
                  <td>
                      <label style='font-family:times; font-size:16px;'>".$umur_meninggal."</label>
                  </td>
                </tr>

                 <tr>
                  <td>
                      <label style='font-family:times; font-size:16px;'>Warga Negara</label>
                  </td>
                  <td>
                      <label style='font-family:times; font-size:16px;'>:</label></td>
                  <td>
                      <label style='font-family:times; font-size:16px;'>".$warga_negara."</label>
                  </td>
                </tr>

                 <tr>
                  <td>
                      <label style='font-family:times; font-size:16px;'>Tempat Meninggal</label>
                  </td>
                  <td>
                      <label style='font-family:times; font-size:16px;'>:</label></td>
                  <td>
                      <label style='font-family:times; font-size:16px;'>".$tmpt_meninggal."</label>
                  </td>
                </tr>
   ...
   echo "<table style='margin-left:60px;' width='100%' height='100%'>
                <tr>
                  <td colspan='3'><br>
                      <label style='font-size:16px;'>Demikian surat keterangan kematian ini dibuat untuk di pergunakan seperlunya</label>
                  </td>
                </tr>
          </table>";
