...
include "koneksi.php";
$id_sku   		= $_GET['id_sku'];
$query    		= mysqli_query($config, " SELECT * FROM  tbl_sku where id_sku='$id_sku'");
$a=mysqli_fetch_array($query);
$id_sku  		= $a['id_sku'];
$no_surat_sku	= $a['no_surat_sku'];
$ket      		= $a['ket'];
?>
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="operator-tabel-sku.php"><i class="menu-icon icon-backward"></i>KEMBALI
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>UBAH SURAT KETERANGAN USAHA</h3>
							</div>
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="operator-proses-ubah-sku.php">
										<?php
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_sku" id="basicinput" class="span8" value="<?php echo $id_sku; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_sku" id="basicinput" class="span8" placeholder="...." autocomplete="off" value="<?php echo $no_surat_sku; ?>" >
											</div>
										</div>	
