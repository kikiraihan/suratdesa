				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator_sktm.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>TABEL SURAT KETERANGAN TIDAK MAMPU</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'koneksi.php';
                                           $query = mysqli_query($config, " SELECT * FROM tbl_sktm, tbl_pegawai, tbl_penduduk WHERE tbl_sktm.id_pg=tbl_pegawai.id_pg AND tbl_sktm.NIK=tbl_penduduk.NIK ORDER BY tbl_sktm.id_sktm ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                                                 ...
                                                 echo '<td>'.$data['no_surat_sktm'].'</td>';
                                                 echo '<td>'.$data['nama_p'].'</td>';
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='operator-cetak-sktm.php?id_sktm=$data[id_sktm]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-ubah-sktm.php?id_sktm=$data[id_sktm]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-hapus-sktm.php?id_sktm=$data[id_sktm]'>
