...
$tahun = date ('Y');
$nomor = "NO:145/BGM-TKBL/".$no_surat_skh."/".$romawi."/".$tahun;
...
echo "<br><br><table border='0' align='center' width='100%' height='100%'>
          <tr>
...
echo  "<br>
      <br>
      <table border='0' style='margin-left:60px;' width='100%' height='100%'>
            <tr>
                <td>
