...
include "koneksi.php";
$id_instansi    = mysqli_escape_string($config,$_GET['id_instansi']);
$query 		    = mysqli_query($config, " SELECT id_instansi, nm FROM tbl_instansi WHERE id_instansi='$id_instansi'");
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="proses-ubah-instansi.php">
											<?php
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_instansi" id="basicinput" class="span8" value="<?php echo $id_instansi; ?>" readonly >
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="nm" id="basicinput" class="span8" value="<?php echo $nm; ?>">
											</div>
										</div>
