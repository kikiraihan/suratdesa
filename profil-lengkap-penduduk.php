							...
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="proses-ubah-penduduk.php">
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $NIK; ?></label>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $nama_p; ?></label> 
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $tempat_lahir; ?></label> 
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $tgl_lahir; ?></label> 
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $jenkel; ?>
												</label> 
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $alamat; ?></label>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $dusun; ?></label>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $kel_desa; ?></label>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $kecamatan; ?></label>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $agama; ?></label>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $s_nikah; ?></label>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $warga_negara; ?></label>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<label class="control-label" for="basicinput"><?php echo $pekerjaan; ?></label>
											</div>
										</div>										
									</form>
							</div>
