...
include "koneksi.php";
$id_skd   		= $_GET['id_skd'];
$query    		= mysqli_query($config, " SELECT * FROM  tbl_skd where id_skd='$id_skd'");
$a=mysqli_fetch_array($query);
$id_skd  		= $a['id_skd'];
$no_surat_skd	= $a['no_surat_skd'];
$ket      		= $a['ket'];
?>
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="operator-tabel-skd.php"><i class="menu-icon icon-backward"></i>KEMBALI
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>UBAH SURAT KETERANGAN DOMISILI</h3>
							</div>
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="operator-proses-ubah-skd.php">
										<?php
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_skd" id="basicinput" class="span8" value="<?php echo $id_skd; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_skd" id="basicinput" class="span8" placeholder="...." autocomplete="off" value="<?php echo $no_surat_skd; ?>">
											</div>
										</div>	
