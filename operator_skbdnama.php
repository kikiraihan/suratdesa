...
<head>
	...
	<script language="javascript">
		...
		function pesan_skbdnama(form_skbdnama){
			if(form_skbdnama.no_surat_bdnama.value == ""){
				alert("No surat belum  di isi !");
				form_skbdnama.no_surat_bdnama.focus();
				return (false);
			
			}else if(form_skbdnama.nama.value == "0"){
				alert("Yang bertanda tangan belum di pilih !");
				form_skbdnama.nama.focus();
				return (false);
			
			}else if(form_skbdnama.nama_p.value == "0"){
				alert("Nama belum di pilih !");
				form_skbdnama.nama_p.focus();
				return (false);
			
			}else if(form_skbdnama.ket_bd_nama.value == ""){
				alert("Keterangan beda nama belum di isi !");
				form_skbdnama.ket_bd_nama.focus();
				return (false);
			}
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator-tabel-skbdnama.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>INPUTAN SURAT KETERANGAN BEDA NAMA</h3>
							</div>
							<div class="module-body">
									<form name="form_skbdnama" onsubmit="return pesan_skbdnama(this)" class="form-horizontal row-fluid" method="post" action="operator-proses-simpan-skbdnama.php">	
									 <?php
										include "koneksi.php";
										$query   = "SELECT max(id_bd_nama) as maxKode FROM tbl_bdnama";
										$hasil   = mysqli_query($config,$query);
										$data    = mysqli_fetch_array($hasil);
										$idsurat = $data['maxKode'];
										$noUrut  = (int) substr($idsurat, 9, 9);
										$noUrut++;
										$char    = "SKBDNAMA";
										...
										?>
                                      	...
                                      	<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_bd_nama" id="basicinput" class="span8" value="<?php echo $idsurat; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_bdnama" id="basicinput" class="span8" placeholder="...." autocomplete="off">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<textarea name="ket_bd_nama" class="span8" rows="5"></textarea>
											</div>
										</div>
