				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="operator-tabel-skh.php"><i class="menu-icon icon-backward"></i>KEMBALI
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>UBAH SURAT KETERANGAN HILANG</h3>
							</div>
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="operator-proses-ubah-skh.php">
										<?php
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_skh" id="basicinput" class="span8" value="<?php echo $id_skh; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_skh" id="basicinput" class="span8" placeholder="...." autocomplete="off" value="<?php echo $no_surat_skh; ?>" >
											</div>
										</div>
