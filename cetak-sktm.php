...
include "koneksi.php";
$id_sktm =  mysqli_escape_string($config,$_GET['id_sktm']);
$query   =  mysqli_query($config, " SELECT * FROM tbl_sktm JOIN tbl_pegawai JOIN tbl_penduduk ON tbl_sktm.id_pg =tbl_pegawai.id_pg AND tbl_sktm.NIK=tbl_penduduk.NIK WHERE tbl_sktm.id_sktm='$id_sktm'");
...
$no_surat_sktm    = $data['no_surat_sktm'];
$ket              = $data['ket'];
}
?>
...
$tahun = date ('Y');
$nomor = "NO:".$no_surat_sktm."/474/D.PIL/".$romawi."/".$tahun;
...
echo "<table align='center' border='0'>
        <tr>
            <td align='center'>
                <u style='font-size:20px; font-weight:bold;' align='center'>SURAT KETERANGAN TIDAK MAMPU</u>
            </td>
        </tr>
        <tr>
...
echo  "<br><table border='0' style='margin-left:60px;'>
            ...
            <tr>
              ...
              <tr>
               ...
               <tr>
                ...
                <tr>
                  <td colspan='3'>
                      <label style='font-family:times; font-size:16px;'>$ket</label>
                  </td>
                </tr>
            </table>";
   ...
   echo "<table style='margin-left:60px;'>
                <tr>
                  <td colspan='3'><br>
                      <label style='font-size:16px;'>Demikian surat keterangan tidak mampu ini dibuat dan diberikan kepada yang bersangkutan</label>
                  </td>
                </tr>
          </table>";
