...
<head>
	...
	<script>
		...
		function pesan_skhewan(form_skhewan){
			if(form_skhewan.no_surat_skhewan.value == ""){
				alert("No surat belum  di isi !");
				form_skhewan.no_surat_skhewan.focus();
				return (false);
			
			}else if(form_skhewan.nama.value == "0"){
				alert("Yang bertanda tangan belum di pilih !");
				form_skhewan.nama.focus();
				return (false);
			
			}else if(form_skhewan.nama_p.value == "0"){
				alert("Nama belum di pilih !");
				form_skhewan.nama_p.focus();
				return (false);
			
			}else if(form_skhewan.ciri_ciri.value == ""){
				alert("Ciri - ciri hewan belum di isi !");
				form_skhewan.ciri_ciri.focus();
				return (false);
			}
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator-tabel-skhewan.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>INPUTAN SURAT KETERANGAN HEWAN</h3>
							</div>
							<div class="module-body">
									<form name="form_skhewan" onsubmit="return pesan_skhewan(this)" class="form-horizontal row-fluid" method="post" action="operator-proses-simpan-skhewan.php">	
									 <?php
										include "koneksi.php";
										$query   = "SELECT max(id_s_ket_hewan) as maxKode FROM tbl_s_ket_hewan";
										$hasil   = mysqli_query($config,$query);
										$data    = mysqli_fetch_array($hasil);
										$idsurat = $data['maxKode'];
										$noUrut  = (int) substr($idsurat, 8, 8);
										$noUrut++;
										$char    = "SKHEWAN";
										...
										?>
                                      	...
                                      	<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_s_ket_hewan" id="basicinput" class="span8" value="<?php echo $idsurat; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_skhewan" id="basicinput" class="span8" placeholder="...." autocomplete="off">
											</div>
										</div>
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Ciri - Ciri Hewan</label>
											<div class="controls">
												<textarea name="ciri_ciri" class="span8" rows="5"></textarea>
											</div>
										</div>
