				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator_skh.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>TABEL SURAT KETERANGAN HILANG</h3>
							</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										<?php
                                            ...
                                            include'koneksi.php';
                                            $query = mysqli_query($config, " SELECT * FROM tbl_skh, tbl_pegawai WHERE tbl_skh.id_pg=tbl_pegawai.id_pg ORDER BY tbl_skh.id_skh ASC");

                                                while($data=mysqli_fetch_assoc($query)){

                                                 echo '<tr>';
                                                 echo '<td>'.$data['id_skh'].'</td>';
                                                 echo '<td>'.$data['jabatan'].'</td>';
                                                 echo '<td>'.$data['no_surat_skh'].'</td>';
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='operator-cetak-skh.php?id_skh=$data[id_skh]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-ubah-skh.php?id_skh=$data[id_skh]'>
                        						 		...
                        						 		<center>
                        						 		<a href='operator-hapus-skh.php?id_skh=$data[id_skh]'>
