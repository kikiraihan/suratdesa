				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="operator-tabel-sktm.php"><i class="menu-icon icon-backward"></i>KEMBALI
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="operator-proses-ubah-sktm.php">
										<?php
