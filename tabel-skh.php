				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="skh.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                            ...
                                            $query = mysqli_query($config, " SELECT * FROM tbl_skh, tbl_pegawai WHERE tbl_skh.id_pg=tbl_pegawai.id_pg ORDER BY tbl_skh.id_skh ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='cetak-skh.php?id_skh=$data[id_skh]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-skh.php?id_skh=$data[id_skh]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-skh.php?id_skh=$data[id_skh]'>
