				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator-tabel-skik.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form name="form_skik" onsubmit="return pesan_skik(this)" class="form-horizontal row-fluid" method="post" action="operator-proses-simpan-skik.php">	
									 <?php
										include "koneksi.php";
										...
										<div class="control-group">
											...
											<div class="controls">
												<select name="tempat" tabindex="1" data-placeholder="Select here.." class="span8">
													<option value="0">--- Pilih ---</option>
													<option value="Dusun I">Dusun I Desa Pilohayanga</option>
													<option value="Dusun II">Dusun II Desa Pilohayanga</option>
													<option value="Dusun III">Dusun III Desa Pilohayanga</option>
												</select>
											</div>
										</div>
