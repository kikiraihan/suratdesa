...
<head>
	...
	<script>
		function pesan_skik(form_skik){
			if(form_skik.no_surat_skik.value == ""){
				alert("No surat belum  di isi !");
				form_skik.no_surat_skik.focus();
				return (false);
			
			}else if(form_skik.nama.value == "0"){
				alert("Yang bertanda tangan belum di pilih !");
				form_skik.nama.focus();
				return (false);
			
			}else if(form_skik.nama_p.value == "0"){
				alert("Nama belum di pilih !");
				form_skik.nama_p.focus();
				return (false);
			
			}else if(form_skik.hari_tanggal.value == ""){
				alert("Hari / tanggal belum di isi !");
				form_skik.hari_tanggal.focus();
				return (false);
			
			}else if(form_skik.waktu.value == ""){
				alert("Waktu belum di isi !");
				form_skik.waktu.focus();
				return (false);
			
			}else if(form_skik.tempat.value == "0"){
				alert("Tempat belum di isi !");
				form_skik.tempat.focus();
				return (false);
			
			}else if(form_skik.hiburan.value == ""){
				alert("Hiburan belum di isi !");
				form_skik.hiburan.focus();
				return (false);
			}
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="tabel-skik.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>INPUTAN SURAT KETERANGAN IZIN KERAMAIAN</h3>
							</div>
							<div class="module-body">
									<form name="form_skik" onsubmit="return pesan_skik(this)" class="form-horizontal row-fluid" method="post" action="proses-simpan-skik.php">	
									 <?php
										include "koneksi.php";
										$query   = "SELECT max(id_s_ket_keramaian) as maxKode FROM tbl_s_ket_izin_keramaian";
										...
										?>
                                      	...
                                      	<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_s_ket_keramaian" id="basicinput" class="span8" value="<?php echo $idsurat; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_skik" id="basicinput" class="span8" placeholder="...." autocomplete="off">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="date" name="tgl" id="basicinput" placeholder="...." autocomplete="off" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="waktu" id="basicinput" placeholder="...." autocomplete="off" class="span8">
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<select name="tempat" tabindex="1" data-placeholder="Select here.." class="span8">
													<option value="0">--- Pilih ---</option>
													<option value="Dusun I Desa Pilohayanga">Dusun I Desa Pilohayanga</option>
													<option value="Dusun II Desa Pilohayanga">Dusun II Desa Pilohayanga</option>
													<option value="Dusun III Desa Pilohayanga">Dusun III Desa Pilohayanga</option>
												</select>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="hiburan" id="basicinput" placeholder="...." autocomplete="off" class="span8">
											</div>
										</div>
