...
<head>
	...
	<script language="javascript">
		...
		function pesan_skd(form_skd){

			if(form_skd.no_surat_skd.value == ""){
				alert("No surat beulum di isi !");
				form_skd.no_surat_skd.focus();
				return (false);
	
			}else if(form_skd.nama.value == "0"){
				alert("Yang bertanda tangan belum di pilih !");
				form_skd.nama.focus();
				return (false);
	
			}else if(form_skd.nama_p.value == "0"){
				alert("Nama penduduk belum di pilih !");
				form_skd.nama_p.focus();
				return (false);
			}
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator-tabel-skd.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>INPUTAN SURAT KETERANGAN DOMISILI</h3>
							</div>
							<div class="module-body">
									<form name="form_skd" onsubmit="return pesan_skd(this)" class="form-horizontal row-fluid" method="post" action="operator-proses-simpan-skd.php">	
									 <?php
										include "koneksi.php";
										$query   = "SELECT max(id_skd) as maxKode FROM tbl_skd";
										...
										?>
                                      	...
                                      	<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_skd" id="basicinput" class="span8" value="<?php echo $idsurat; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_skd" id="basicinput" class="span8" placeholder="...." autocomplete="off">
											</div>
										</div>
