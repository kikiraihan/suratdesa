				...
				<div class="span3">
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="sku.php"><i class="menu-icon icon-plus"></i>TAMBAH
                                </a></li>
										...
										<?php
                                           ...
                                           $query = mysqli_query($config, " SELECT * FROM tbl_sku, tbl_pegawai, tbl_penduduk WHERE tbl_sku.id_pg=tbl_pegawai.id_pg AND tbl_sku.NIK=tbl_penduduk.NIK ORDER BY tbl_sku.id_sku ASC");
                                                ...
                                                while($data=mysqli_fetch_assoc($query)){
                        						 ...
                        						 echo"<td>
                        						 		<center>
                        						 		<a href='cetak-sku.php?id_sku=$data[id_sku]'>
                        						 		...
                        						 		<center>
                        						 		<a href='ubah-sku.php?id_sku=$data[id_sku]'>
                        						 		...
                        						 		<center>
                        						 		<a href='hapus-sku.php?id_sku=$data[id_sku]'>
