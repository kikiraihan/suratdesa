...
$query    		= mysqli_query($config, " SELECT * FROM  tbl_skkb where id_skkb='$id_skkb'");
$a=mysqli_fetch_array($query);
$id_skkb  		= $a['id_skkb'];
$no_surat_skkb 	= $a['no_surat_skkb'];
$ket      		= $a['ket'];
?>
				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                <li class="active"><a href="operator-tabel-skkb.php"><i class="menu-icon icon-backward"></i>KEMBALI
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>UBAH SURAT KETERANGAN KELAKUAN BAIK</h3>
							</div>
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="post" action="operator-proses-ubah-skkb.php">
										<?php
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="id_skkb" id="basicinput" class="span8" value="<?php echo $id_skkb; ?>" readonly>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="no_surat_skkb" id="basicinput" class="span8" placeholder="...." autocomplete="off" value="<?php echo $no_surat_skkb; ?>">
											</div>
										</div>	
