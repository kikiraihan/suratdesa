				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator-tabel-skkb.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form name="form_skkb" onsubmit="return pesan_skkb(this)" class="form-horizontal row-fluid" method="post" action="operator-proses-simpan-skkb.php">	
									 <?php
										include "koneksi.php";
