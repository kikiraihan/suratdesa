				...
				<div class="span3">
					 <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="operator-tabel-s-kematian.php"><i class="menu-icon icon-table"></i>TABEL SURAT
                                </a></li>
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									<form name="form_s_kematian" onsubmit="return pesan_s_kematian(this)" class="form-horizontal row-fluid" method="post" action="operator-proses-simpan-s-kematian.php">	
									 <?php
										include "koneksi.php";
